...
async function TranslateSetting(setting: Setting | null) {
  ...
  const prompt = "Generate a "+ word_num + "-word " + setting.format + "which has lexile level " + setting.li.toString() + "and title flanked by < and >. The text should be about the following keywords: " + translated_keywords + ". Don't generate syntax like <h1> and **."
